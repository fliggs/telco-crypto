...
import {
  ExpoGoogleAuthenticationAuthorizeOptions,
  ExpoGoogleAuthenticationAuthorizeResponse,
...
export function authorize(
  options: ExpoGoogleAuthenticationAuthorizeOptions
): Promise<ExpoGoogleAuthenticationAuthorizeResponse> {
  return ExpoGoogleAuthenticationModule.authorize(options);
}
